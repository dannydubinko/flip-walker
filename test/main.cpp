...
void loop() {
  ...
  float strength = hallsensor.getFieldStrength(1.1); // 1.4 is typical for SS49E
    
  Serial.print("Magnetic Field: ");
  Serial.print(strength);
  Serial.println(" Gauss");

  // if (abs(strength) > 50.0) {
  //     Serial.println("--- Magnet Detected! ---");
  // }

  Serial.print("Voltage: ");
  Serial.print(hallsensor.getVoltage());
